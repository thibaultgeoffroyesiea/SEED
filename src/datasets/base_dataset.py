...
def get_data_AU(path, num_tasks, nc_first_task, validation, shuffle_classes, class_order=None):
    ...
    # ALL OR TRAIN
    for this_image, this_au ,this_label in trn_lines:
        ...
        data[this_task]['trn']['au'].append(this_au)
    ...
    for this_image, this_au, this_label in tst_lines:
        ...
        data[this_task]['tst']['au'].append(this_au)
        ...
        for tt in data.keys():
            for cc in range(data[tt]['ncla']):
                ...
                for ii in range(len(rnd_img)):
                    ...
                    data[tt]['val']['au'].append(data[tt]['trn']['au'][rnd_img[ii]])
                    data[tt]['val']['y'].append(data[tt]['trn']['y'][rnd_img[ii]])
                    data[tt]['trn']['x'].pop(rnd_img[ii])
                    data[tt]['trn']['au'].pop(rnd_img[ii])
